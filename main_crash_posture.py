...
CRASH_THRESHOLD = 4.0 * 9.81  # Crash detection > 4/5 g
CRASH_CHECK_INTERVAL = 250  # in ms 200
...
#         self.last_accel = {"x": x, "y": y, "z": z}
    ...
    def _start_data_collection(self):
        ...
        self._crash_detection_and_posture_timer = self.create_virtual_timer(CRASH_CHECK_INTERVAL, self._check_crash_and_posture)
